...
template<class I>
inline
    typename boost::unordered::detail::enable_if_forward<I, std::size_t>::type
    insert_size(I i, I j)
{
...
template<class I>
inline
    typename boost::unordered::detail::disable_if_forward<I, std::size_t>::type
    insert_size(I, I)
{
  return 1;
}
...
struct emplace_args1
{
  ...
  explicit emplace_args1(Arg0 b0)
      : a0(b0)
  {
  }
};
...
struct value_base
{
  ...
  typename boost::aligned_storage<sizeof(value_type),
                                  boost::alignment_of<value_type>::value>::type
      data_;
...
public:
  ...
  optional(BOOST_RV_REF(optional<T>) x)
      : has_value_(false)
  {
    if (x.has_value_) {
      move(x);
...
BOOST_PP_REPEAT_FROM_TO(6,
                        BOOST_PP_INC(BOOST_UNORDERED_TUPLE_ARGS),
...
#  define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(z, n, namespace_) \
    ...
    void construct_from_tuple_impl( \
        boost::unordered::detail::func::length<n>, \
        Alloc&, \
        T* ptr, \
        namespace_::tuple<BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const& x) \
    { \
...
inline void construct_from_args(Alloc& alloc,
                                T* address,
                                BOOST_FWD_REF(Args)... args)
{
  boost::allocator_construct(alloc, address, boost::forward<Args>(args)...);
}
...
inline typename boost::enable_if_c<use_piecewise<A0>::value
                                   ...
                                   void>::type
construct_from_args(Alloc& alloc,
                    std::pair<A, B>* address,
                    BOOST_FWD_REF(A0),
                    BOOST_FWD_REF(A1) a1,
                    BOOST_FWD_REF(A2) a2)
{
  boost::allocator_construct(alloc,
                             address,
...
inline void construct_from_args(Alloc&,
                                T* address,
...
BOOST_PP_REPEAT_FROM_TO(10,
                        BOOST_PP_INC(BOOST_UNORDERED_EMPLACE_LIMIT),
                        BOOST_UNORDERED_CONSTRUCT_IMPL,
                        _)
...
inline typename boost::allocator_pointer<Alloc>::type construct_node_from_args(
    Alloc& alloc, BOOST_UNORDERED_EMPLACE_ARGS)
{
  typedef typename boost::allocator_value_type<Alloc>::type node;
  typedef typename node::value_type value_type;
  typedef
      typename boost::allocator_rebind<Alloc, value_type>::type value_allocator;
...
inline typename boost::allocator_pointer<Alloc>::type construct_node_pair(
    Alloc& alloc, BOOST_FWD_REF(Key) k)
{
  node_constructor<Alloc> a(alloc);
  a.create_node();
  ...
  boost::allocator_construct(val_alloc,
                             a.node_->value_ptr(),
                             std::piecewise_construct,
...
construct_node_pair_from_args(Alloc& alloc,
                              BOOST_FWD_REF(Key) k,
                              BOOST_FWD_REF(Args)... args)
{
  node_constructor<Alloc> a(alloc);
...
public:
      ...
      : current_(0)
  {
    construct_functions(
        ...
        boost::unordered::detail::
            integral_constant<bool, nothrow_move_constructible>());
  }
  ...
  {
    return *::boost::unordered::detail::launder(static_cast<function_pair*>(
...
private:
  ...
  void construct_functions(unsigned char which,
                           function_pair const& f,
...
template<typename T>
struct rv_ref
    : boost::conditional<boost::is_class<T>::value,
...
public:
  ...
  bool operator==(
      boost::unordered::detail::iterator_detail::c_iterator<Node, Bucket> const&
          other) const BOOST_NOEXCEPT
  {
    return equal(other);
  }
...
private:
  ...
  bool equal(const iterator& x) const BOOST_NOEXCEPT { return (p == x.p); }

  bool equal(
      const boost::unordered::detail::iterator_detail::c_iterator<Node, Bucket>&
          x) const BOOST_NOEXCEPT
  {
    return (p == x.p);
  }
...
public:
  ...
  bool operator==(
      boost::unordered::detail::iterator_detail::iterator<Node, Bucket> const&
          other) const BOOST_NOEXCEPT
  {
    return equal(other);
  }
...
private:
  ...
  value_type const& dereference() const BOOST_NOEXCEPT { return p->value(); }

  bool equal(const c_iterator& x) const BOOST_NOEXCEPT { return (p == x.p); }
...
template<typename Types>
struct table
    : boost::unordered::detail::functions<typename Types::hasher,
...
public:
  ...
  typedef
      typename boost::allocator_pointer<node_allocator_type>::type node_pointer;
...
public:
  ...
  std::size_t max_bucket_count() const
  {
    ...
    return size_policy::size(
        size_policy::size_index(boost::allocator_max_size(this->node_alloc())));
  }
  ...
  void recalculate_max_load()
  {
    ...
    max_load_ = bc == 0
        ? 0
        : boost::unordered::detail::double_to_size(static_cast<double>(mlf_)
  ...
  table(table& x, boost::unordered::detail::move_tag m)
      ...
      , buckets_(boost::move(x.buckets_))
  {
    x.size_ = 0;
    x.max_load_ = 0;
  }
  ...
  void swap(table& x)
  {
    ...
    swap(x,
         boost::unordered::detail::
             integral_constant<bool, functions::nothrow_swappable>());
  }
  ...
  void move_construct_buckets(table& src)
  {
    ...
    for (iterator pos = src.begin(); pos != src.end(); ++pos) {
      node_tmp b(detail::func::construct_node(this->node_alloc(),
                                              boost::move(pos.p->value())),
                 this->node_alloc());
  ...
  {
    typedef typename boost::allocator_propagate_on_container_copy_assignment<
        node_allocator_type>::type pocca;

    if (this != &x) {
      assign(x,
             is_unique,
             boost::unordered::detail::integral_constant<bool, pocca::value>());
    }
  }
  ...
  inline iterator transparent_find(Key const& k,
                                   Hash const& h,
  ...
  // Reserve and rehash
  void transfer_node(node_pointer p,
                     bucket_type&,
  ...
  iterator emplace_hint_unique(c_iterator hint,
                               const_key_type& k,
                               BOOST_UNORDERED_EMPLACE_ARGS)
  {
  ...
  template<BOOST_UNORDERED_EMPLACE_TEMPLATE>
  emplace_return emplace_unique(const_key_type& k, BOOST_UNORDERED_EMPLACE_ARGS)
  {
    std::size_t key_hash = this->hash(k);
    bucket_iterator itb = buckets_.at(buckets_.position(key_hash));
                                    ...
                                    BOOST_UNORDERED_EMPLACE_ARGS)
  {
    ...
    node_tmp b(boost::unordered::detail::func::construct_node_pair_from_args(
  ...
  template<typename Key, BOOST_UNORDERED_EMPLACE_TEMPLATE>
  iterator try_emplace_hint_unique(c_iterator hint,
                                   BOOST_FWD_REF(Key) k,
                                   BOOST_UNORDERED_EMPLACE_ARGS)
  {
    if (hint.p && this->key_eq()(hint->first, k)) {
  ...
  void move_assign_buckets(table& src, true_type)
  {
    ...
    for (iterator pos = src.begin(); pos != last; ++pos) {
      ...
      node_tmp tmp(detail::func::construct_node(alloc, boost::move(value)),
                   alloc);
  ...
  static bool group_equals_equiv(iterator n1,
                                 iterator end1,
                                 iterator n2,
                                 iterator end2)
  {
  ...
  static std::size_t count_equal_equiv(iterator n,
                                       iterator last,
                                       value_type const& v)
  {
    std::size_t count = 0;
...
{
  num_buckets = (std::max)(min_buckets(size_, mlf_),
...
{
  bucket_array_type new_buckets(num_buckets, buckets_.get_node_allocator());
  ...
  BOOST_CATCH(...)
  {
    for (bucket_iterator pos = new_buckets.begin(); pos != new_buckets.end();
         ++pos) {
      bucket_type& b = *pos;
      for (node_pointer p = b.next; p;) {
        node_pointer next_p = p->next;
...
struct is_key
{
  ...
  typedef typename boost::conditional<value, Key const&, no_key>::type type;
};
