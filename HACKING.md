...
hidden if the `rock_paper_scissors_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `rock_paper_scissors_DEVELOPER_MODE` to the configure
...
Runs the executable target `rock_paper_scissors_exe`.
